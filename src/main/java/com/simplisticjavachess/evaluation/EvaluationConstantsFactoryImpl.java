...
public class EvaluationConstantsFactoryImpl implements EvaluationConstantsFactory
{
    ...
    private static final IntegerEvaluation WHITE_IS_MATE =  new IntegerEvaluation(-2147480000);
    private static final IntegerEvaluation BLACK_IS_MATE =  new IntegerEvaluation(2147480000);

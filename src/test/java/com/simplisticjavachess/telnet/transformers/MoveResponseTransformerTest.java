...
public class MoveResponseTransformerTest {
    ...
    String response5 = "#@#014Jeanf           *nonmonolithic   :  KR  NRPPQN PPP  PBP             bn        pp  pp p " +
            " ppr bqk  r010B35350058300582o-o-o  (0:01)@#@";
    ...
    public void isApplicableTest() {
        ...
        assertTrue(handler.isApplicable(response5));
    }
    ...
    public void parseMoveTest() {
        ...
        assertEquals(Optional.of("o-o-o"), handler.parseMove(response5));
    }
}